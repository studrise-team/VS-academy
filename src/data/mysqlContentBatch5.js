...
export const mysqlContentBatch5 = {
  ...
  'mysql_views': {
    ...
    hasLiveOutput: false, expectedOutput: 'Query OK, 0 rows affected (0.01 sec)\\n\\n+----------+-------------+\\n| name     | order_count |\\n+----------+-------------+\\n| Alice    |           5 |\\n| Bob      |           2 |\\n+----------+-------------+',
    explanation: [
  ...
  'mysql_indexes': {
    ...
    hasLiveOutput: false, expectedOutput: 'Query OK, 0 rows affected (0.03 sec)\\nRecords: 0  Duplicates: 0  Warnings: 0\\n\\n-- Query now runs much faster!',
    explanation: [
  ...
  'mysql_triggers': {
    ...
    hasLiveOutput: false, expectedOutput: 'Query OK, 0 rows affected (0.02 sec)\\n\\n-- When UPDATE runs, trigger fires\\n-- audit_log table now has 1 row',
    explanation: [
  ...
  'mysql_transactions': {
    ...
    hasLiveOutput: false, expectedOutput: 'Query OK, 0 rows affected (0.00 sec)\\n\\nQuery OK, 1 row affected (0.01 sec)\\n\\nQuery OK, 1 row affected (0.01 sec)\\n\\nQuery OK, 0 rows affected (0.00 sec)',
    explanation: [
  ...
  'mysql_rollback': {
    ...
    hasLiveOutput: false, expectedOutput: 'Query OK, 0 rows affected (0.00 sec)\\n\\nQuery OK, 1 row affected (0.01 sec)\\n\\nQuery OK, 0 rows affected (0.00 sec)\\n-- Changes are reverted. Table is back to original state.',
    explanation: [
  ...
  'mysql_er_diagram': {
    ...
    hasLiveOutput: false, expectedOutput: '-- Conceptual\\n[Users] 1 ---> N [Orders]\\n[Orders] N <--- 1 [Products]',
    explanation: [
  ...
  'mysql_1nf': {
    ...
    hasLiveOutput: false, expectedOutput: '-- Before (Violates 1NF):\\nBob | Math, Science\\n\\n-- After (1NF Compliant):\\nBob | Math\\nBob | Science',
    explanation: [
  ...
  'mysql_2nf': {
    ...
    hasLiveOutput: false, expectedOutput: '-- Table must be in 1NF and have no partial dependencies.\\n-- Separate Order data from Product data.',
    explanation: [
  ...
  'mysql_3nf': {
    ...
    hasLiveOutput: false, expectedOutput: '-- Table must be in 2NF and have no transitive dependencies.\\n-- City and State depend on Zip Code, not User ID. Move them to a ZipCode table.',
    explanation: [
  ...
  'mysql_with_java': {
    ...
    hasLiveOutput: false, expectedOutput: 'Connected to MySQL!\\nUser: Alice\\nUser: Bob',
    explanation: [
  ...
  'mysql_with_php': {
    ...
    hasLiveOutput: false, expectedOutput: 'Connected successfully\\nid: 1 - Name: Alice\\nid: 2 - Name: Bob',
    explanation: [
  ...
  'mysql_with_nodejs': {
    ...
    hasLiveOutput: false, expectedOutput: 'Connected to the MySQL server.\\n[ { id: 1, name: \'Alice\' }, { id: 2, name: \'Bob\' } ]',
    explanation: [
  ...
  'mysql_with_python': {
    ...
    hasLiveOutput: false, expectedOutput: '(1, \'Alice\')\\n(2, \'Bob\')',
    explanation: [
  ...
  'mysql_vs_firebase': {
    ...
    hasLiveOutput: false, expectedOutput: '-- Conceptual Comparison\\nMySQL: Relational, strict schema, SQL, scales vertically.\\nFirebase: NoSQL, document-based, flexible, real-time, scales horizontally.',
    explanation: [
  ...
  'mysql_project_student': {
    ...
    hasLiveOutput: false, expectedOutput: 'Query OK, 0 rows affected (0.05 sec)\\n-- Tables created: students, courses, enrollments',
    explanation: [
  ...
  'mysql_project_employee': {
    ...
    hasLiveOutput: false, expectedOutput: 'Query OK, 0 rows affected (0.05 sec)\\n-- Tables created: departments, employees, salaries',
    explanation: [
  ...
  'mysql_interview_questions': {
    ...
    hasLiveOutput: false, expectedOutput: '-- Conceptual: Review top questions like:\\n-- What is a JOIN?\\n-- Difference between TRUNCATE and DELETE?',
    explanation: [
  ...
  'mysql_query_questions': {
    ...
    hasLiveOutput: false, expectedOutput: '-- Conceptual: Review complex queries like:\\n-- Find the second highest salary.\\n-- Find duplicate records.',
    explanation: [
  ...
  'mysql_scenario_questions': {
    ...
    hasLiveOutput: false, expectedOutput: '-- Conceptual: How to design a schema for a specific use case.\\n-- E.g., Database for a food delivery app.',
    explanation: [
  ...
  'mysql_common_mistakes': {
    ...
    hasLiveOutput: false, expectedOutput: '-- Review: Forgetting WHERE in DELETE, using SELECT * in production, ignoring indexes.',
    explanation: [
  ...
  'mysql_cheat_sheet': {
    ...
    hasLiveOutput: false, expectedOutput: '-- A quick reference to all major MySQL commands.\\nSELECT, INSERT, UPDATE, DELETE, CREATE, DROP, ALTER, JOINs, GROUP BY.',
    explanation: [
