...
export const mysqlContentBatch4 = {
  ...
  'mysql_joins_intro': {
    ...
    hasLiveOutput: false, expectedOutput: '-- Conceptual output only\\nTable A (Left)   Table B (Right)\\nCommon matching field connects them.',
    explanation: [
  ...
  'mysql_composite_key': {
    ...
    hasLiveOutput: false, expectedOutput: 'Query OK, 0 rows affected (0.02 sec)\\n\\nERROR 1062 (23000): Duplicate entry \'101-1001\' for key \'enrollments.PRIMARY\'',
    explanation: [
  ...
  'mysql_unique_key': {
    ...
    hasLiveOutput: false, expectedOutput: 'Query OK, 0 rows affected (0.02 sec)\\n\\nERROR 1062 (23000): Duplicate entry \'alice@email.com\' for key \'users.email\'',
    explanation: [
