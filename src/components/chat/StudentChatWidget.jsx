...
import { MessageSquare, X, Send, Shield, User, Loader2 } from 'lucide-react';
...
export function StudentChatWidget() {
  ...
  // Don't render for guests or admin
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="pointer-events-auto mb-4 w-[350px] sm:w-[385px] h-[500px] max-h-[80vh] bg-card border border-borderGlass rounded-2xl shadow-2xl flex flex-col overflow-hidden glass"
          >
            {/* Header */}
